...
fetch(`https://fakestoreapi.com/products/${value}`)
  ...
  .then((product) => {
    ...
    // isAlreadyInProduct -> {id: 10, title: 'SanDisk SSD PLUS 1TB Internal SSD - SATA III 6 Gb/s', price: 109, description: 'Easy upgrade for faster boot up, shutdown, applica…drive capacity, host device, OS and application.)', category: 'electronics', …},
    // undefined - null
    const productHTML = `
